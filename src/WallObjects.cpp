...
namespace atg {
    ...
    WallObjects::WallObjects(std::shared_ptr<SdlInitializer> passed_csdl_setup,const int passedX,const int passedY,double* const passedCameraX,
                           double* const passedCameraY,const unsigned short rockType) :
